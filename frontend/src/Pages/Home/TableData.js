...
const TableData = (props) => {
  ...
  const handleEditSubmit = async (e) => {
    ...
    const { data } = await axios.put(`${editTransactions}/${currId}`, updatedValues);
            ...
            {props.data.map((item, index) => (
              <tr key={index}>
                ...
                >
                  ...
                  {item.amount} <span style={{ fontSize: "1rem" }}>₹</span>
                </td>
                <td>{item.transactionType}</td>
                <td>{item.category}</td>
                <td style={{ textAlign: "center", verticalAlign: "middle" }}>
                  <div
                    className="icons-handle"
                              ...
                              <Modal.Body>
                                ...
                                >
                                  ...
                                  <Form.Select
                                    ...
                                    onChange={handleChange}
                                  >
                                    <option value={editingTransaction[0].category}>{editingTransaction[0].category}</option>
